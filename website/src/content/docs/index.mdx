...
Pure Index can be used either through a [command line interface](/pure-index/intro/cli) with an optional [configuration file](/pure-index/reference/configuration) or its [JavaScript API](/pure-index/intro/js-api).
