...
Pure Index can be used either through a [command line interface](/pure-index/intro/cli) with an optional [configuration file](/pure-index/reference/configuration), or else through its JavaScript API.
